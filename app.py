...
def hello_word():
    return render_template("solution.html",btnshow=True, imageExist=True)
...
def upload_predict():
    if request.method == "POST":
        ...
        if image_file:
            ...
            # ------------------New Code End-------------------------
            return render_template("solution.html", result = Final_Result, imageName= image_file.filename, imageExist=False, btnshow=False)
